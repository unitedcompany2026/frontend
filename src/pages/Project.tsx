    ...
    <div className="bg-white rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.06),0_2px_6px_rgba(0,0,0,0.04),inset_0_0_0_1px_rgba(0,0,0,0.03)] overflow-hidden">
      <div className="relative h-64 bg-gray-100">
        ...
        <div className="absolute top-3 left-3">
          ...
          >
            {layout.available ? 'available' : 'sold out'}
          </span>
        </div>
      </div>
...
export default function Project() {
  ...
  const project = {
    ...
    consultant: {
      name: 'Vladislav Sikorskiy',
      title: 'Korter Real Estate Consultant',
    ...
    layouts: [
      {
        ...
        available: true,
        image:
          'https://images.unsplash.com/photo-1632490199272-05b16c62315e?w=800&h=600&fit=crop',
      },
      {
        id: 2,
        name: '2-room',
        ...
        available: true,
        image:
          'https://images.unsplash.com/photo-1632490199435-9fca53f49814?w=800&h=600&fit=crop',
      },
      {
        id: 3,
        name: '3-room',
        ...
        available: true,
        image:
          'https://images.unsplash.com/photo-1632490199417-c4d67c8fb5e0?w=800&h=600&fit=crop',
      },
    ],
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 py-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 bg-white rounded-xl shadow-sm">
              <div className="border-b flex gap-6 px-6">
                <button className="py-4 border-b-2 border-blue-900 text-blue-900 font-medium">
                  Layouts and prices
                </button>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-8">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 24 24"
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
            <span>
              Prices and availability are up to date as of 10 October 2025
            </span>
            <button className="text-blue-900 hover:underline ml-2">
              Report inaccuracies
            </button>
          </div>
          ...
          <div className="flex gap-4 mb-6">
            ...
            <button className="px-6 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg font-medium hover:bg-gray-50">
              6 properties from sellers
            </button>
          </div>
